(function() {
    ...
    MembershipDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'Membership', 'User', 'Pool'];

    function MembershipDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, Membership, User, Pool) {
        var vm = this;
